import os
import time
from my_agent import generate_response, generate_with_fallback
import dotenv
dotenv.load_dotenv()

# Judge Configuration
# We no longer configure genai directly here, as generate_with_fallback handles it.
...
"""
    try:
        response = generate_with_fallback(
            ...
            system_instruction="You are an impartial Judge evaluating an AI agent's response.",
            prompt=judge_prompt
        )
